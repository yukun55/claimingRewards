...
public class CompleteQuestControllerTest {
    ...
    public void contextLoads() throws Exception {
        assertThat(completeQuestController).isNotNull();
    }

    @Test void postCompleteQuestsControllerShouldSave() throws Exception{
        this.mockMvc.perform(MockMvcRequestBuilders
                .post("/completeQuest/{questId}", "1")
                .content(asJsonString(new CompletedQuestsId(null, "1")))
